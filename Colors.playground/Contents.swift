...
// Color(red: 199 / 255.0, green: 136 / 255.0, blue: 153 / 255.0)
func getRGBCode(line: String) -> String {
    var rgbColor = line
//    // rgbColor = "<td>(199,136,153)</td>"
    rgbColor = removeTD(str: rgbColor)
    rgbColor = rgbColor.replacingOccurrences(of: " ", with: "")
    rgbColor = rgbColor
...
func changeNameIfStandartColor(colorName: String) -> String {
    let listOfStandartColors = [
        "black",
        "blue",
        "brown",
        "clear",
    ...
    return listOfStandartColors.contains(colorName) ? colorName + "1" : colorName
}
...
func getColorName(line: String) -> String {
    ...
    result = result.firstLowercased
    result = removeAfterBackSlash(str: result)
    return changeNameIfStandartColor(colorName: result)
}
